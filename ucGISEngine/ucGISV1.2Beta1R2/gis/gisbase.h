...
typedef unsigned char  INT8U,uint8;                    /* Unsigned  8 bit quantity                           */
typedef signed   char  INT8S;                    /* Signed    8 bit quantity                           */
typedef unsigned short INT16U,uint16;                   /* Unsigned 16 bit quantity                           */
typedef signed   short INT16S;                   /* Signed   16 bit quantity                           */
typedef unsigned int   INT32U,uint32;                   /* Unsigned 32 bit quantity                           */
...
#define EARTH_WGS84_A	6378137.0000	//长轴
#define EARTH_WGS84_B	6356752.3142	//短轴
#define EARTH_WGS84_E2	0.00669437999013	//偏心率平方
#define EARTH_WGS84_MPM	1852.0			//米与英里转换
#define EARTH_WGS84_FLATTENING	298.257223563	//地球扁率
...
GISBASE_EXT BOOLEAN mapPtInRect( mapMAPRECTSTRCT* r,GeoPoint* point);
GISBASE_EXT int FieldVar(const char *buf, int fldnum, int sep, char *dest);

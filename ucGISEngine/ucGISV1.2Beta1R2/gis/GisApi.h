...
GISAPI_EXT BOOLEAN SearchMapUseIndex(char * filepath,UcMap *pucmap,GISCHAR* szKey, MAPSearchIndex *pmapSearchinde, int * nCount,int maxcount);
GISAPI_EXT void MapGotoSearch(char *filepath,MapCoorTrans *pcoortrans,MAPSearchIndex mapSearchinde);
